...
since = str(now.year) + "-" + str(now.month) + "-" + str(now.day-14) #bug here
...
msgstring = msgstring + "Media hours completed this year: " + str(sumofproject) + "\n"
...
for tries in range(8):
	try:
		slack.chat.post_message('#andy', msgstring)
		break
